  ...
  return (
    <>
      <button
        ...
        className="mt-6 inline-flex items-center justify-center gap-2 rounded-md bg-[color:var(--color-accent)] px-4 py-2 text-sm font-medium text-black hover:opacity-90"
      >
        <Plus size={16} />
        Create token
      </button>
      ...
      {open && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/45 px-4">
          <div className="w-full max-w-xl rounded-lg border border-[color:var(--color-border)] bg-[color:var(--color-background)] p-6 shadow-xl">
              ...
              <form onSubmit={createToken} className="mt-6 space-y-5">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-md border border-[color:var(--color-border)] bg-transparent px-3 py-2"
                  />
                </label>
                ...
                <button
                  type="submit"
                  disabled={pending}
                  className="inline-flex items-center gap-2 rounded-md bg-[color:var(--color-accent)] px-4 py-2 text-sm font-medium text-black hover:opacity-90 disabled:opacity-50"
                >
                  <Plus size={16} />

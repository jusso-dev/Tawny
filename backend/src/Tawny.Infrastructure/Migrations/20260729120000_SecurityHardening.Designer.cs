...
namespace Tawny.Infrastructure.Migrations
{
    ...
    [Migration("20260729120000_SecurityHardening")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.Agent", b =>
                {
                    ...
                    b.Property<int>("LastClockSkewSeconds")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset?>("LastHeartbeatAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<int>("LastIngestEventCount")
                        .HasColumnType("int");

                    b.Property<Guid?>("LastTelemetryBatchId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.AlertRule", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Format", "ExternalId");

                    b.HasIndex("TenantId", "IsEnabled", "EventType");
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.CloudConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.CloudFinding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CloudHuntId", "DedupeKey")
                        .IsUnique();

                    b.HasIndex("TenantId", "Status", "OccurredAt")
                        .IsDescending(false, false, true);

                    b.ToTable("CloudFindings");
                });

            modelBuilder.Entity("Tawny.Domain.Entities.CloudHunt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("WatermarkAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("TenantId", "IsEnabled", "LastRunAt");

                    b.ToTable("CloudHunts");
                });

            modelBuilder.Entity("Tawny.Domain.Entities.CloudHuntRun", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CloudHuntId");

                    b.HasIndex("TenantId", "CloudHuntId", "StartedAt")
                        .IsDescending(false, false, true);

                    b.ToTable("CloudHuntRuns");
                });
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.ResponseAction", b =>
                {
                    ...
                    b.Property<string>("ExecutionTokenHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("TenantId", "AgentId", "IdempotencyKey");
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.TelemetryEvent", b =>
                {
                    ...
                    b.HasIndex("TenantId", "AgentId", "BatchId");

                    b.HasIndex("TenantId", "AgentId", "ClientEventId")
                        .IsUnique()
                        .HasFilter("[ClientEventId] IS NOT NULL");

                    b.HasIndex("TenantId", "AgentId", "SequenceNumber");
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.CloudFinding", b =>
                {
                    b.HasOne("Tawny.Domain.Entities.CloudHunt", "CloudHunt")
                        .WithMany("Findings")
                        .HasForeignKey("CloudHuntId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CloudHunt");
                });

            modelBuilder.Entity("Tawny.Domain.Entities.CloudHunt", b =>
                {
                    b.HasOne("Tawny.Domain.Entities.CloudConnection", "CloudConnection")
                        .WithMany("Hunts")
                        .HasForeignKey("CloudConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tawny.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Navigation("CloudConnections");

                    b.Navigation("CloudHunts");
